...
const InProcessBookings = () => {
    ...
    const { inProcessBookings,HandleAddInProcessBookingsToArchive } = context;

    return (
        <div>
            {inProcessBookings.length > 0
                ? inProcessBookings.map((booking) => (
                    ...
                    <div className="card-header">
                        ...
                        <button className="btn btn-secondary float-right" onClick={()=>HandleAddInProcessBookingsToArchive(booking.BookingId)}>
                            Add to Archive
                        </button>
                    </div>
                          <div className="row">
...
export default InProcessBookings;
